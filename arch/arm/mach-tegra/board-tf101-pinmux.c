/*
 * arch/arm/mach-tegra/board-tf101-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config tf101_drive_pinmux[] = {
	DEFAULT_DRIVE(VI1),
	DEFAULT_DRIVE(SDIO1),
...
static __initdata struct tegra_pingroup_config tf101_pinmux[] = {
...
int __init tf101_pinmux_init(void)
{
	tegra_pinmux_config_table(tf101_pinmux, ARRAY_SIZE(tf101_pinmux));
	tegra_drive_pinmux_config_table(tf101_drive_pinmux,
					ARRAY_SIZE(tf101_drive_pinmux));
